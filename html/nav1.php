        ...
        <div class="before-case">
            ...
            <div class="media-firmitem">
                ...
                <div class="media-body">
                    ...
                    <div class="media-labels1">
                        <span>报名人数: 100</span>
                        <span>验房师: 王麻子</span>
                    </div>
                    <p class="media-text">成华区陆扇门经营部成立于1997年，下设成都市六扇门精品实
                        木门厂成华区陆扇门经营部成华区陆扇门经营部，是一家专业从事实木门、
                        套装门开发、生产、销售为一体的...</p>
                </div>
            </div>
            <div class="media-firmitem">
                <div class="media-left">
                    <a href="" class="thumbnail"><img src="../img/img2.png" alt=""/></a>
                </div>
                <div class="media-body">
                    <h4 class="media-title"><a href="">成都禾木艺景装饰工程有限公司</a></h4>
                    <div class="media-labels1">
...
<!--        </div>-->
    ...
    <img src="../img/1-yangfang.png" alt=""/>
</div>
