	...
	function initEvent() {
		...
		jq(':input.btn_f25618_round, a.btn_f25618, #zxd_act_btn, a.bottom_apply_btn').click(function() {
			...
			if(!username) {//未登录， 弹出登陆框
				showPopWin('http://www.to8to.com/pop_login.php', 500, 426, function() {
